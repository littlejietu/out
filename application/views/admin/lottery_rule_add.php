...
<div class="right_con common adduser">
	...
	<a href="/admin/lottery_rule" class="topBtn">返回列表</a>
	<?php echo validation_errors('<div class="valid_error">', '</div>');?>
	<form action="/admin/lottery_rule/save<?php if( !empty($info['id']) ) echo '?id='. _get_key_val( $info['id'] ); ?>" method="post">
		...
		<table class="addTable">
			<tbody>
		        ...
		        <tr>
		            <td height="25" align="right"> 编码：</td>
		            <td align="left" class="padL10"><input type="text" name="code" value="<?php if( !empty($info['code']) ) echo $info['code']; ?>" style="width:300px" maxlength="200" /></td>
		        </tr>
		        <tr>
		            <td height="25" align="right"> 满足条件说明：</td>
		            <td align="left" class="padL10"><input type="text" name="title" value="<?php if( !empty($info['title']) ) echo $info['title']; ?>" style="width:300px" maxlength="200" /></td>
		        </tr>
		        <tr>
		            <td height="25" align="right"> 条件json：</td>
		            <td align="left" class="padL10"><input type="text" name="rulejson" value="<?php if( !empty($info['rulejson']) ) echo $info['rulejson']; ?>" style="width:300px" maxlength="200" /></td>
		        </tr>
		         <!-- <tr>
